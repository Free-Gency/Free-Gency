...
/// <summary>
/// The frontend-facing moderation verdict for a marketplace review. This is the
/// stable contract the client consumes; it is projected from the richer
/// <see cref="ReviewModerationResponse"/> service result so the API surface stays
/// small, explicit and versionable. It can be extended (or branched into
/// comment/chat/portfolio contracts) without changing the service layer.
/// </summary>
public sealed record ReviewModerationApiResponse
{
    ...
    /// <summary>
    /// Gets the frontend display status derived from <see cref="Action"/>: one of
    /// "Safe", "Warning", "Masked", "Rejected", or "Manual Review". Drives the
    /// status badge (green, yellow, orange, red, orange respectively).
    /// </summary>
    ...
    /// <summary>Gets the AI model that produced this result, when the AI service ran.</summary>
