-- Backfill hired proposals + normalize notification ActionUrl values.
-- Status is stored as nvarchar (enum string conversion).
...
-- 5) Normalize notification ActionUrl values (legacy paths)
...
SELECT [ActionUrl], COUNT(*) AS [Count]
