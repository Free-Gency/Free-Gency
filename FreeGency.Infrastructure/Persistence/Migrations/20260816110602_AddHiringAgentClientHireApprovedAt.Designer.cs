...
namespace FreeGency.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260816110602_AddHiringAgentClientHireApprovedAt")]
    partial class AddHiringAgentClientHireApprovedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreeGency.Domain.Entities.HiringAgentCandidate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<float?>("DiscussionScore")
                        .HasColumnType("real");
                    ...
                    b.Property<Guid>("HiringAgentRunId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("LatestPlanVersionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<float>("SuggestionScore")
                        .HasColumnType("real");
                    ...
                    b.HasIndex("HiringAgentRunId");

                    b.HasIndex("InvitationId");

                    b.HasIndex("LatestPlanVersionId");

                    b.HasIndex("ProposalId");

                    b.HasIndex("Status");

                    b.ToTable("HiringAgentCandidates", "marketplace", t =>
                        {
                            t.HasCheckConstraint("CK_HiringAgentCandidates_InviteeScope", "(InviteeType = 'User' AND InviteeUserId IS NOT NULL AND InviteeTeamId IS NULL) OR (InviteeType = 'Team' AND InviteeTeamId IS NOT NULL AND InviteeUserId IS NULL)");
                        });
                });

            modelBuilder.Entity("FreeGency.Domain.Entities.HiringAgentRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime?>("ClientHireApprovedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("DiscussionDeadlineUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("InviteDeadlineUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<Guid?>("RecommendedPlanVersionId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("RecommendedProposalId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RecommendedCandidateId");

                    b.HasIndex("RecommendedPlanVersionId");

                    b.HasIndex("RecommendedProposalId");

                    b.HasIndex("Status");

                    b.HasIndex("ProjectId", "Status");

                    b.ToTable("HiringAgentRuns", "marketplace");
                });
            ...
            modelBuilder.Entity("FreeGency.Domain.Entities.HiringAgentCandidate", b =>
                {
                    ...
                    b.HasOne("FreeGency.Domain.Entities.HiringAgentRun", "HiringAgentRun")
                        .WithMany("Candidates")
                        .HasForeignKey("HiringAgentRunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FreeGency.Domain.Entities.ProjectInvitation", "Invitation")
                        .WithMany()
                        .HasForeignKey("InvitationId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("FreeGency.Domain.Entities.MilestonePlanVersion", "LatestPlanVersion")
                        .WithMany()
                        .HasForeignKey("LatestPlanVersionId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("HiringAgentRun");

                    b.Navigation("Invitation");

                    b.Navigation("LatestPlanVersion");
            ...
            modelBuilder.Entity("FreeGency.Domain.Entities.HiringAgentRun", b =>
                {
                    ...
                    b.HasOne("FreeGency.Domain.Entities.HiringAgentCandidate", "RecommendedCandidate")
                        .WithMany()
                        .HasForeignKey("RecommendedCandidateId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("FreeGency.Domain.Entities.MilestonePlanVersion", "RecommendedPlanVersion")
                        .WithMany()
                        .HasForeignKey("RecommendedPlanVersionId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("FreeGency.Domain.Entities.ProjectProposal", "RecommendedProposal")
                        .WithMany()
                        .HasForeignKey("RecommendedProposalId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("RecommendedCandidate");

                    b.Navigation("RecommendedPlanVersion");

                    b.Navigation("RecommendedProposal");
                });
