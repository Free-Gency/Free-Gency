...
public interface IMilestonePlanVersionRepository : IGenericRepository<MilestonePlanVersion>
{
    ...
    Task<IEnumerable<MilestonePlanVersion>> GetByProposalIdAsync(Guid proposalId, CancellationToken ct = default);
    ...
    Task<int> CountByProposalIdAsync(Guid proposalId, CancellationToken ct = default);
}
