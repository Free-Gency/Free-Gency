...
/// <summary>
/// A lightweight, immutable log state that implements the structured-logging
/// shape consumed by <see cref="Microsoft.Extensions.Logging.ILogger"/>. Every
/// log line produced by <see cref="ChatModerationLogger"/> is backed by this
/// state so all key-value fields (event name, request id, correlation id,
/// conversation id, UTC timestamp, ...) are captured by any structured log sink.
/// </summary>
